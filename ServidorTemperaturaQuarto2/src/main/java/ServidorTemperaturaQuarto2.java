...
public class ServidorTemperaturaQuarto2 {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        new Thread(() -> {
            try {
                ...
                if (Dados.estaVazio()) {
                    Servidor servidor = new Servidor("Quarto 2", TipoSensor.TEMPERATURA, 0);
        ...
        Bully bullyServidor = new Bully(200, listaParametroServidores, 400, false);
        ...
        new Thread(() -> {
            try (ServerSocket serverSocket = new ServerSocket(50062)) {
        ...
        new Thread(() -> {
            try {
                ServerSocket serverSocket = new ServerSocket(50072);
