    ...
    public static void main(String[] args) throws IOException, InterruptedException {
                    ...
                    if (!bullyServidor.isLider()) {
                        ...
                        try {
                            ...
                            if (!response.getMensagem().equals("Sim")) {
                                System.out.println("\u001B[31m" + "Lider não correspondeu como esperado" + "\u001B[0m");
        ...
        new Thread(() -> {
            try {
                ...
                Server grpcServer = ServerBuilder.forPort(50061)
        ...
        new Thread(() -> {
            try {
                ServerSocket serverSocket = new ServerSocket(60071);
