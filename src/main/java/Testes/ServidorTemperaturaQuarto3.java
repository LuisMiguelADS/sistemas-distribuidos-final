    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        new Thread(() -> {
            try {
                ...
                Servidor server = new Servidor("Quarto 3", TipoSensor.TEMPERATURA, 0);
        ...
        Bully bullyServidor = new Bully(300, listaParametroServidores, 200, false);
        ...
        new Thread(() -> {
            try {
                ...
                Server grpcServer = ServerBuilder.forPort(50063)
        ...
        new Thread(() -> {
            try {
                ServerSocket serverSocket = new ServerSocket(60073);
