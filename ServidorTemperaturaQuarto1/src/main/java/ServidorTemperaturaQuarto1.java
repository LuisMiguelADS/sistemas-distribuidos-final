    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        new Thread(() -> {
            try {
                ...
                if (Dados.estaVazio()) {
                    Servidor servidor = new Servidor("Quarto 1", TipoSensor.TEMPERATURA, 0);
        ...
        Bully bullyServidor = new Bully(100, listaParametroServidores, 0, false);
        ...
        new Thread(() -> {
            try (ServerSocket serverSocket = new ServerSocket(50061)) {
        ...
        new Thread(() -> {
            try {
                ServerSocket serverSocket = new ServerSocket(50071);
