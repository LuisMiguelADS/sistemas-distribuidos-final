    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        new Thread(() -> {
            try {
                ...
                if (Dados.estaVazio()) {
                    Servidor servidor = new Servidor("Banheiro 1", TipoSensor.UMIDADE, 0);
        ...
        Bully bullyServidor = new Bully(400, listaParametroServidores, 0, false);
        ...
        // Thread para ficar recebendo mensagens via socket
        // No caso, só vai receber mensagens se for o líder
        new Thread(() -> {
            try (ServerSocket serverSocket = new ServerSocket(50064)) {
        ...
        new Thread(() -> {
            try {
                ServerSocket serverSocket = new ServerSocket(50074);
