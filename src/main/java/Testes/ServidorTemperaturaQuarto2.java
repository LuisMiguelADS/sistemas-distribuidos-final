    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        new Thread(() -> {
            try {
                ...
                Servidor server = new Servidor("Quarto 2", TipoSensor.TEMPERATURA, 0);
        ...
        Bully bullyServidor = new Bully(200, listaParametroServidores, 200, true);
        ...
        new Thread(() -> {
            try {
                ...
                Server grpcServer = ServerBuilder.forPort(50062)
        ...
        new Thread(() -> {
            try {
                ServerSocket serverSocket = new ServerSocket(60072);
